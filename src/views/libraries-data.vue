  ...
  <div>
    ...
    <v-container>
      <v-sheet color="grey-lighten-5" class="py-4 px-4" rounded>
        ...
        <p class="my-2">Choose a local authority from the list. Areas are listed in
      ...
      <v-sheet color="grey-lighten-5" class="py-4 px-4" rounded>
        <h2 class="text-h6 text-info">2 Edit data</h2>
        <p class="my-2">Select fields to change values. For additional field editing use the edit
          icon for each library. <strong>
            Changes are not permanently saved until you select publish changes in
            the next step.
          </strong></p>
        <v-data-table :headers="headers" :items="libraries" sort-by="name" disable-sort :loading="loadingServiceData"
